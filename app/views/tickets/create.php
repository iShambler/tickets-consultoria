...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <a href="<?= base_url('dashboard.php') ?>" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Volver</a>
</div>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header"><h5 class="mb-0">Información del Ticket</h5></div>
            <div class="card-body">
                <form method="POST" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="titulo" name="titulo"
                               ...
                               placeholder="Breve descripción del problema o consulta" required maxlength="200">
                        <small class="text-muted">Mínimo 5 caracteres</small>
                    </div>
                    <div class="mb-3">
                        <label for="tipo_consultoria_id" class="form-label">Tipo de consultoría <span class="text-danger">*</span></label>
                        <select class="form-select" id="tipo_consultoria_id" name="tipo_consultoria_id" required>
                            <option value="">Selecciona un tipo</option>
                            <?php foreach ($tipos as $tipo): ?>
                                <option value="<?= $tipo['id'] ?>" <?= ($_POST['tipo_consultoria_id'] ?? '') == $tipo['id'] ? 'selected' : '' ?>><?= e($tipo['nombre']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="prioridad" name="prioridad">
                            <?php foreach (config('prioridades') as $key => $value): ?>
                                <option value="<?= e($key) ?>" <?= ($_POST['prioridad'] ?? 'media') === $key ? 'selected' : '' ?>><?= e($value) ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descripcion" name="descripcion" rows="8" required
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary btn-lg"><i class="bi bi-plus-circle"></i> Crear Ticket</button>
    ...
    <div class="col-md-4">
        <div class="card bg-light">
            <div class="card-body">
                ...
                <p class="card-text">Al crear un ticket, nuestro equipo será notificado y un consultor será asignado para atender tu solicitud.</p>
                <hr>
